    ...
    registry.registerCommand(
      {
        ...
        description:
          "Make your streamed chat from mc look like your discord messages (on discord)",
    ...
    registry.registerCommand(
      {
        ...
        description:
          "Reset your streamed picture and nametag to your xbox account (requires relog)",
        permissionLevel: CommandPermissionLevel.GameDirectors,
      },
      (origin) => {
    ...
    registry.registerCommand(
      {
        ...
        description:
          "Stop messages from discord from being visualised on your screen",
        permissionLevel: CommandPermissionLevel.GameDirectors,
      },
      (origin) => {
        if (origin.sourceType !== CustomCommandSource.Entity) {
  ...
  switch (origin.sourceType) {
    case CustomCommandSource.Entity:
      if (origin.sourceEntity.typeId === "minecraft:player") {
        const prefix =
          result.status === CustomCommandStatus.Success ? "§e" : "§c";
