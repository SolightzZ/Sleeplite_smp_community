...
const death_name = "esploratori:death_counter",
  kills_name = "esploratori:kill_counter",
  mobs_name = "esploratori:mob_counter",
  pvpdeath_name = "esploratori:pvpdeath";

const death_obj =
  world.scoreboard.getObjective(death_name) ??
  world.scoreboard.addObjective(death_name, "number of deaths");
const kills_obj =
  world.scoreboard.getObjective(kills_name) ??
  world.scoreboard.addObjective(kills_name, "players killed");
const mob_kills_obj =
  world.scoreboard.getObjective(mobs_name) ??
  world.scoreboard.addObjective(mobs_name, "mobs killed");
const pvp_death_obj =
  world.scoreboard.getObjective(pvpdeath_name) ??
  world.scoreboard.addObjective(pvpdeath_name, "number of pvp deaths");
