...
const breakScoreboard =
  world.scoreboard.getObjective("esploratori:blocks_broken") ??
  world.scoreboard.addObjective("esploratori:blocks_broken", "blocks mined");
const breakScoreboardAll =
  world.scoreboard.getObjective("esploratori:blocks_broken_all") ??
  world.scoreboard.addObjective(
    "esploratori:blocks_broken_all",
    "blocks mined (overall)",
  );

const placeScoreboard =
  world.scoreboard.getObjective("esploratori:blocks_placed") ??
  world.scoreboard.addObjective("esploratori:blocks_placed", "blocks placed");
const placeScoreboardAll =
  world.scoreboard.getObjective("esploratori:blocks_placed_all") ??
  world.scoreboard.addObjective(
    "esploratori:blocks_placed_all",
    "blocks placed (overall)",
  );
