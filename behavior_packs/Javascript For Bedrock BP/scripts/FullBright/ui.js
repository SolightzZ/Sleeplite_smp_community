...
import { title, onText, offText, onIcon, offIcon, msgOn, msgOff } from "./const.js";
import { hasBright, setBright } from "./state.js";

const build = (on) => new ActionFormData().title(title).button(on ? onText : offText, on ? onIcon : offIcon);
