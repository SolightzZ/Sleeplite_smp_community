...
const mainMenu = async (player) => {
    const form = new ActionFormData().title('Settings Menu').button('Server Settings', 'textures/ui/sidebar_icons/categories').button('HUD Settings', 'textures/ui/sidebar_icons/my_characters');
