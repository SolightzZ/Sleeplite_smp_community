export const JOBS_ADDON_CONFIG = {
    ...
    rewards: {
        // This scoreboard objective is still used by !jbal, !jpay, upgrades, and any score rewards.
        ...
        activity: [
            { type: 'score', objective: 'money', amountSource: 'computed' }
        ...
        quest: [
            { type: 'score', objective: 'money', amountSource: 'configured' }
