...
world.beforeEvents.worldInitialize.subscribe((initEvent) => {
   try {
      initEvent.itemComponentRegistry.registerCustomComponent('be_chocolate_bucket_mid:trigger', {
         onConsume: (e) => {
      ...
      initEvent.itemComponentRegistry.registerCustomComponent('ber_bucket_chocolate_low:trigger', {
         onConsume: (e) => {
            e.source.removeEffect('minecraft:nausea');
            e.source.removeEffect('minecraft:poison');
            e.source.removeEffect('minecraft:weakness');
      ...
      initEvent.itemComponentRegistry.registerCustomComponent('ber_chocolate_bucket_full:trigger', {
         onConsume: (e) => {
            e.source.removeEffect('minecraft:weakness');
            e.source.removeEffect('minecraft:wither');
            e.source.removeEffect('minecraft:slowness');
      ...
      initEvent.itemComponentRegistry.registerCustomComponent('ber_lush_salad:trigger', {
         onConsume: (e) => {
            e.source.addEffect('minecraft:night_vision', 400, { amplifier: 1 });
         },
      });

      initEvent.itemComponentRegistry.registerCustomComponent('ber_honey_sausage:trigger', {
         onConsume: (e) => {
            e.source.removeEffect('minecraft:blindness');
            e.source.removeEffect('minecraft:nausea');
            e.source.removeEffect('minecraft:poison');
      ...
      console.error('[ FoodExpanded ] Failed to register custom components: ' + error.message);
   }
});
